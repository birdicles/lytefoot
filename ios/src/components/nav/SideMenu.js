/**
 * STOLEN FROM: https://github.com/Kureev/react-native-side-menu/blob/master/styles.js
 * - not compatible with babel transformation
 */
import React, {
    Dimensions,
    Animated,
...
export default class SideMenu extends Component {
    ...
    handlePanResponderMove(e, gestureState) {
        if (this.menuPositionMultiplier() * (this.state.left.__getValue() + gestureState.dx ) >= 0 ) {
